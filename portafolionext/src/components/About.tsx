      ...
      <div className="flex flex-col lg:flex-row lg:w-full items-center justify-between mb-6">
        <div className="lg:w-1/2 w-full mb-6 lg:mb-0 px-4 lg:px-0">
          ...
          <p className="text-lg mb-6">
            Soy Edson Orlando Castañeda Urrego, un desarrollador de 33 años de Bogotá, Colombia. 👨‍💻 Tengo experiencia en diversas tecnologías adquiridas durante mi participación en el bootcamp de Henry. A lo largo de este proceso, he trabajado en múltiples proyectos que me han permitido aplicar y profundizar mis conocimientos, desde el frontend hasta el backend. Estoy comprometido con el aprendizaje continuo 📚 y busco mi primer empleo en el sector IT para seguir creciendo profesionalmente y contribuir de manera significativa a proyectos innovadores. 🚀
          </p>
          <p className="text-lg">
